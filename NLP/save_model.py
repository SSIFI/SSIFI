...
# # REPORTER BOT && WRITER BOT
# # Model 은 따로 다운로드
# save_dir_tokenizer_reporterbot = './models/reporterbot/tokenizer'
# save_dir_tokenizer_writerbot = './models/writerbot/tokenizer'
# Q_TKN = "<usr>"
# A_TKN = "<sys>"
# BOS = '</s>'
# EOS = '</s>'
...
#             bos_token=BOS, eos_token=EOS, unk_token='<unk>',
#             pad_token=PAD, mask_token=MASK)
# tokenizer.save_pretrained(save_dir_tokenizer_reporterbot)
# tokenizer.save_pretrained(save_dir_tokenizer_writerbot)
